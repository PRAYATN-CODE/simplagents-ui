...
export default function Index() {
  ...
  useEffect(() => {
    if (activeAgent && shambhoAccessToken) {
      const url = `https://app.simplagents.com/agent/${activeAgent?.agentId}/agentic-ai?token=${encodeURIComponent(
        shambhoAccessToken
      )}&isIframe=true`;
  ...
  }, [activeAgent, shambhoAccessToken]);
